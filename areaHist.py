...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 12 11:09:00 2023
...
for k in range(10,13):
    ...
    lessAreaVector = [np.log(q) for q in areaVector[0] if q < 50000]
    PVector = [np.log(q) for q in perimeterVector[0] if 0<q<50000]
    SVector = [np.log(q) for q in sidesVector[0] if 0<q <50000]
    plt.hist(lessAreaVector, alpha = 0.3, bins = 30)
    plt.hist(PVector, alpha = 0.3, bins = 30)
  #  plt.xscale('log', base = 10)
    plt.hist(SVector, alpha = 0.3, bins = 30)
