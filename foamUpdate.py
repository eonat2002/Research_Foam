...
img4 = cv2.imread("sample15.JPG",0)

img4 = img4[1500:2500,3000:4500]

#img4 = img4[1000:2000,2500:3500]
...
sure_bg = cv2.dilate(255-opening, kernel, iterations = 0)
sure_bg = 255-sure_bg
...
# make a new array with cells that have same number of edges


# #At this point, we'd like to put a labeling on an image.

img6 = color.label2rgb(markers2,bg_label=0)
fig, ax = plt.subplots()
ax.imshow(img6)
fig, ax = plt.subplots()
ax.imshow(img6)
plt.title('Interior Cells of a Foam')
plt.xlabel('pixels')
plt.ylabel('pixels')
